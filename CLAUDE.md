...
- **Research — M12 Build 4½: the shakedown is running.** Plan: [m12-plan.md](docs/design/m12-plan.md) (charter [ADR-0101](docs/decisions/ADR-0101-architecture-review-m12-recharter.md), design [§3e](docs/design/anvil-design-v2.md)); session record: [m12-running-record.md](docs/design/m12-running-record.md).
  ...
  - **Arms:** recipe CLOSED 09-23 at 0.5240 ± 0.0112 (+0.55pp, noise; 16 iterations, 30.6 h). Alloc CLOSED 09-24 at **0.5405 ± 0.0111** (+2.2pp, ≈ 1.4 SE; 20 iterations, 32.65 h — the wall check is per iteration boundary). Shallow CLOSED 09-25 21:46 at 0.5320 ± 0.0112 (+1.35pp, ≈ 1.2 SE; 26 iterations, 30.67 h wall of which ≈ 2.1 h was a GPU yield to a foreign job — price it at ≈ 28 productive hours). Deep running since 09-25 21:46, ≈ 5.5 h per iteration (the priced bench arm's full flag set), closes ≈ 09-27 05:00.
