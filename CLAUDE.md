...
- **M0 design phase complete.** Remaining M0 scope is implementation: `PlayerControllerAnvil` + `anvil` launcher in the fork, `.proto` + Python random-legal server + orchestrator in `anvil/bridge/`, then the three-arm bridge-tax measurement.
