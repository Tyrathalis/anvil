...
- **Remaining M0 scope:** bridge protocol draft (ADR-0001 invariants) + `PlayerController` override plan + batch-harness spec (disposable workers, pause/resume, worker-count/JVM-flag defaults from the scaling sweeps).
