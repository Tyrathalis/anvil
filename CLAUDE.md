...
- **M0 design phase complete.** Remaining M0 implementation scope: the batch orchestrator (`anvil/bridge/harness/`, per the harness spec) + the calibrated multi-worker bridge-tax measurement (w=16, ≥100 games/arm, quiet box).
