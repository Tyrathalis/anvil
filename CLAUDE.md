...
- **M0 design phase complete. Remaining M0 scope: the calibrated multi-worker bridge-tax measurement** (w=16, ≥100 games/arm, quiet box, via the orchestrator) — then M0 is done.
