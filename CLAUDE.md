...
| Day-zero ckpt (M12 Build 1) | `data/training/m12-build1/last.pt` — one-ply 0.390 ± 0.019 / state 0.392 (ADR-0103); never promoted, the Build 2 arm |
...
| Research fork pin | engine `23c3d2a85d`; **Build 0 boundary tip `aac9f808bcf`**; Build 3 enumerators `6eb64b6c538` (exempt, forkcheck pending) (ADR-0102; obs sv=3; forkcheck 497/500 vs the 08-21 seeds on the final jar, the 3 misses = the identity-hash residual — PASS 09-06); the recording jar's ADR-0025 proof discharged by transitivity |
