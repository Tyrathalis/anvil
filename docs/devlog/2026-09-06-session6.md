...
## The control arms (09-07, 14:02) — the value head carries it
...
1. DONE 09-07: both reads adjudicated (IN-BAND; the value head carries it — ADR-0104 addenda). Build 2
   CLOSED. Open: Build 3; the shakedown's bar pinned at 0.10; the post-Build-4 re-read is against `ref`.
2. DONE 09-07 (the control arms ran on `b4825285529`). Was: the Java is committed (fork `1d4b2d817c3`, + the loop guard `b4825285529`: `-searchseats` names a
